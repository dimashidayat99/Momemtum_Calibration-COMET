      ...
      { 
        ...
        if(hasPi0){
          ...
          if (track_gamma0 && !track_gamma1){
            ...
            if(track_electron0){
              COMET::IGeomInfo::DetectorSolenoid().GetDetPositionInDSCoordinate(track_electron0->GetInitialPosition().Vect(), gamma_pos_local);
            ...
            if(track_electron1){
              COMET::IGeomInfo::DetectorSolenoid().GetDetPositionInDSCoordinate(track_electron1->GetInitialPosition().Vect(), gamma_pos_local);
              h_gamma_decayvtx_r->Fill(gamma_pos_local.Perp(),1);
              h_gamma_decayvtx_z->Fill(gamma_pos_local.Z(),1);
              h2_gamma_decayvtx_rz->Fill(gamma_pos_local.Z(),gamma_pos_local.Perp(),1);
              h2_gamma_decayvtx_rz_v2->Fill(gamma_pos_local.Z(),gamma_pos_local.Perp(),1);
