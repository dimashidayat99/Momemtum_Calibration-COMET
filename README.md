...
The ICEDUST Software was setup using the following [command](https://github.com/dimashidayat99/Momemtum_Calibration-COMET/blob/main/Instructions/UMHPC_ICEDUST_Setup.md) for UMHPC server and [command](https://github.com/dimashidayat99/Momemtum_Calibration-COMET/blob/main/Instructions/Deprecated/DICC_COMET_Setup.md) for DICC server.
